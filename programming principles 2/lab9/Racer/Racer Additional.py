...
background = pygame.image.load("C:\\Users\\User\\Documents\\programming-principles-2\\lab8\\Racer\\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\Users\\User\\Documents\\programming-principles-2\\lab8\\Racer\\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\Users\\User\\Documents\\programming-principles-2\\lab8\\Racer\\Player.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(("C:\\Users\\User\\Documents\\programming-principles-2\\lab8\\Racer\\coin.png"))
        self.rect = self.image.get_rect()
...
image_coin = ("C:\\Users\\User\\Documents\\programming-principles-2\\lab8\\Racer\\Player.png")
...
while True:
    ...
    if collision_coin:
        pygame.mixer.Sound("C:\\Users\\User\\Documents\\programming-principles-2\\lab8\\Racer\\coin_sounds.wav").play()
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("C:\\Users\\User\\Documents\\programming-principles-2\\lab8\\Racer\\crash.wav").play()
        time.sleep(1)
